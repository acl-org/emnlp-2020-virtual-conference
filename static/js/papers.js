...
const card_image = (openreview, show) => {
    if (show) return ` <center><img class="lazy-load-img cards_img card-img" data-src="${openreview.card_image_path}" onerror="javascript:this.onerror=null;this.src=''" width="80%"/></center>`
    else return ''
};
